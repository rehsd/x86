...
; Latest update: USB Mouse - Nano w/ 286 IRQ 2 support
; Assembler: NASM
...
section .data
	...
	; EQU's
		...
		MOUSE_IVT_OFFSET	equ 10*4				; Base address of mouse interrupt (IRQ) in IVT  // 9*4=36=0x24
													; Keyboard: IRQ2, INT number 0x0A (10) (* 4 bytes per INT)
...
test_flash_write:
	...
	mov		cx, 0xc000					; write to e0000 + offset in bx
	...
	mov		cx, 0xd000					; write to e0000 + offset in bx
	mov		bx, 0x0002					; offset within segment
	mov		dx,	0x4567					; data
	call	flash_write_byte
	...
	mov		cx, 0xf000					; write to e0000 + offset in bx
	mov		bx, 0x0006					; offset within segment
	mov		dx,	0xcdef					; data
	call	flash_write_byte
