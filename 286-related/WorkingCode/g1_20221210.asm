...
post_RAM:
	...
	mov		si, 0x9000				; segment - will start by subtracting 0x1000 (i.e., 0x9000 as top)
	mov		es, si
...
kbd_get_scancode:
	...
	mov		dx,				PPI2_CTL
	out		dx,				al
	mov		[ppi2_ccfg],	al					; Remember current config
