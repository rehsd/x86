...
varstart:
	...
	dummy1					db		0x0					; without this, inc of pixel_offset_v (in print_char_vga) messes up charPixelRowLoopCounter -- why??
														; alignment issue? shouldn't the assember take care of that?
