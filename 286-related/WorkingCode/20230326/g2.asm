...
times 0x20000-($-$$)-2000 db 0xff	; Fill much of ROM with FFs to allow for faster writing of flash ROMs
...
section .doscomcpp start=0x28000
times 0x0100 db 0x00
incbin "hello_cpp.com"

		
times 0x03800 db 0xff	; Fill much of ROM with FFs to allow for faster writing of flash ROMs
