...
varstart:
	...
	resb 256-102											; 30:00 - #112 = see total at bottom of following section
	...
	resb 20												; 40:4c to 40:5f - video/cursor info
	cursor_end_scan_line	db		?					; 40:60
	cursor_start_scan_line	db		?					; 40:61
	resb 5												; 40:62 to 40:66
	...
	; ******* less critical... ****
	kb_buffer times 64		dw      ?					; 64-word keyboard buffer
	...
	; !!! anything beyond addr 0x0600 will be overwritten when kernel is loaded!

	last_bss_var			db		?
	
	resb 1
	test_struct_even_placement	times 3		dw		?			; testing different writes/reads

	resb 1
	test_struct_odd_placement	times 3		dw		?			; testing different writes/reads


	text_output_buffer			times 128	db		?
	text_output_wptr						db		?					; buffer write pointer
	text_output_rptr						db		?					; buffer read pointer
	cursor_visible			db		?
	VIA1_T1_count			dw		?							; track the number of times the VIA interrupt has occurred
